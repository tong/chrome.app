...
extern class Udp {
	...
	static function bind( socketId : Int, address : String, port : Int, paused : Bool, f : Int->Void ) : Void;
	static function send( socketId : Int, data : ArrayBuffer, address : String, port : Int, paused : Bool, f : {resultCode:Int,?bytesSent:Int}->Void ) : Void;
